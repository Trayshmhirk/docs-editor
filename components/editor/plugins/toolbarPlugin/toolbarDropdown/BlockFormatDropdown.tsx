...
export default function BlockFormatDropDown({
  ...
  return (
    ...
    >
      <DropDownItem
        className={
          "item wide flex w-[250px] max-w-[250px] min-w-[100px] items-center justify-between rounded p-2 text-[15px] hover:enabled:bg-[#eee] dark:hover:enabled:bg-[#3b3b3b] " +
      ...
      <DropDownItem
        className={
          "item wide flex w-[250px] max-w-[250px] min-w-[100px] items-center justify-between rounded p-2 text-[15px] hover:bg-[#eee] dark:hover:bg-[#3b3b3b] " +
